...
export default function EscolaPage() {
  ...
  return (
    <>
      ...
      <a
        href={`https://wa.me/5511941073157?text=${encodeURIComponent(`Olá Dr. Vinícius, estou analisando o relatório ENAMED 2025 da ${escola.nome} e gostaria de tirar dúvidas.`)}`}
        target="_blank"
